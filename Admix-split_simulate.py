...
def standard_stats(ts):
    samples = ts.samples()
    pops = [ts.samples(population=0),ts.samples(population=1),ts.samples(population=2)]
    stats = [ts.f2([pops[0],pops[1]]),ts.f2([pops[0],pops[2]]),ts.f2([pops[1],pops[2]]),
             ts.Fst([pops[0],pops[1]]),ts.Fst([pops[0],pops[2]]),ts.Fst([pops[1],pops[2]]),
             ts.f3([pops[2],pops[0],pops[1]]),ts.f3([pops[1],pops[0],pops[2]]),ts.f3([pops[0],pops[1],pops[2]]),
