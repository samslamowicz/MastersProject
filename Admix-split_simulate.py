...
def local_ancestry_stats(ts,pop,anc_pops,plot=False,return_l=False):
    ...
    #print(sample_stats)
    if plot:
        plt.hist(l_t,bins=80,histtype = 'step')
        plt.hist(l_0_t,bins=80,histtype = 'step')
        plt.hist(l_1_t,bins=80,histtype = 'step')
        plt.show()
